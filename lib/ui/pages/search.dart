...
class _SearchState extends State<Search> {
  ...
  User? _user, _currentUser; // Declare _user and _currentUser as nullable
  int? difference; // Declare difference as nullable

  Future<void> getDifference(GeoPoint? userLocation) async {
    Position position = await Geolocator.getCurrentPosition(); // Use the static method
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        iconWidget(Icons.clear, () {
                          _searchBloc.add(
                            PassUserEvent(widget.userId, _user!.uid, currentUserId: '', selectedUserId: ''),
                          );
